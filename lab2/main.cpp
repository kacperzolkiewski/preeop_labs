...
int main() {
  ...
  const double moveLatitude = 5.;
  const double moveLongitude = 10.;
  move(&krk, moveLatitude, moveLongitude);
  print(krk);
    
  clear(irkutsk);
    
  MapPoint* tab[] = { krk, nyc, porto };
...
/*
 ...
 Porto
 Position of Krakow. Latitude: 55.0614. Longitude: 29.9383
 */
