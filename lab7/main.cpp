...
int main() {
  ...
  //MyString stst("witaj");//to nie powinno sie kompilowac - brak implementacji oznacza -1 pkt.
  MyString s1 = MyString::create("witaj");
  s1.print();
  ...
  MyString s3 = MyString::create("ciekawie");
